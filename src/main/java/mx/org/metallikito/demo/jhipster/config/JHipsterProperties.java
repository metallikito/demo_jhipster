...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "demo_jhipster@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "demo_jhipster API";

        private String description = "demo_jhipster API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "demo_jhipster";
